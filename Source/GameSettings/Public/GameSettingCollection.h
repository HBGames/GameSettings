...
public:
	...
	/**
	 * Detach a setting from this collection. Clears the child's parent
	 * pointer. Does NOT unregister the child from the owning registry;
	 * call UGameSettingRegistry::RemoveByHandle for that.
	 */
	UE_API bool RemoveSetting(UGameSetting* Setting);
